...
// Create connection
$conn = mysqli_connect('localhost:3308', 'root','','departmental_lv');
// Check connection
if (!$conn) {
...
{
window.location.href='/laravel/departmental/shop';
};
     </script>";
    }
  }
...
?>
		...
		<form  method="POST" action='/laravel/departmental/checkout'>
...
</html><?php /**PATH C:\xampp\htdocs\laravel\departmental\resources\views/checkout.blade.php ENDPATH**/ ?>