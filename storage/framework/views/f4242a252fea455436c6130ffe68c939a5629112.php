	...
	<header>
		<div class="main-head">
			<div class="head-content">
				<h2><a href="<?php echo e(url('/home')); ?>"><b>Departmental <i style="font-size: 50px; color: #d9ad26;">S</i>tore</b></a></h2>
			...
			<div class="categories">
				...
				<div class="navigation">
					<ul>
						...
						<li><a href="<?php echo e(url('/shop#')); ?>" id="myBtn" style="color: black; text-decoration: none;">Cart<span class="logo1">&#128722</span></a></li>				
...
<?php
$connection=mysqli_connect('localhost:3308','root','','departmental_lv');
if(! $connection ) {
  ...
  if (event.target == modal) {
	...
	$s=0;
	 if(array_key_exists('button1', $_POST)) { 
        ...
        function button1() { 
            $con=mysqli_connect('localhost:3308','root','','departmental_lv');
             if(! $con ) {
               die('Could not connect: ' . mysql_error());
            }
            else
	...
	<div class="main-container">
		<div class="line1">
			<div class="card">
				...
				<form method="POST" action="<?php echo e(url('/shop')); ?>">
...
<?php /**PATH C:\xampp\htdocs\departmental\resources\views/shop.blade.php ENDPATH**/ ?>